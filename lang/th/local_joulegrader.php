...
$string['pluginname'] = 'เปิดผู้ให้เกรด';
$string['joulegrader:grade'] = 'งานเกรดผ่านตัวเลือกเปิดผู้ให้เกรด';
$string['joulegrader:view'] = 'ดูงานที่ได้รับเกรดผ่านตัวเลือกเปิดผู้ให้เกรด';
...
$string['mobilenotsupported'] = 'เปิดผู้ให้เกรดไม่รองรับเบราว์เซอร์มือถือในปัจจุบัน';
...
$string['navviewlabel'] = 'มุมมอง {$a}';
$string['commentdeleted'] = 'ผู้ใช้งาน {$a->deletedby} ลบโพสต์เมื่อ {$a->deletedon}';
$string['deletecomment'] = 'ลบความคิดเห็นที่สร้างเมื่อ {$a}';
$string['previous'] = '{$a} ก่อนหน้า';
$string['next'] = '{$a} ถัดไป';
$string['assignmentavailable'] = 'พร้อมใช้งาน';
$string['on'] = 'เมื่อ {$a}';
$string['until'] = 'จนถึง {$a}';
$string['lastedited'] = 'แก้ไขครั้งล่าสุดเมื่อ {$a}';
$string['assign23-latesubmission'] = 'การส่งนี้ล่าช้าเป็นเวลา {$a}';
$string['assign23-userextensiondate'] = 'อนุญาตให้ขยายเวลาจนถึง: {$a}';
...
$string['activitycomment'] = 'ความคิดเห็น';
$string['overallfeedback'] = 'ผลตอบรับโดยรวม';
$string['filefeedback'] = 'ผลตอบรับสำหรับไฟล์';
$string['attemptnumber'] = 'ความพยายาม {$a->attemptnumber}: {$a->attempttime}';
$string['viewingattempt'] = 'ความพยายามในการดู';
$string['attemptstatus'] = 'ผู้เรียนได้พยายาม {$a->number} ครั้งจากทั้งหมด {$a->outof} ครั้ง';
$string['assignmentstatus'] = 'สถานะงานที่มอบหมาย';
$string['unlimited'] = 'ไม่จำกัด';
$string['gradebookgrade'] = 'เกรดปัจจุบันในสมุดเกรด';
$string['attemptgrade'] = 'เกรดครั้งที่';
$string['gradeoutof'] = 'เกรด (จากทั้งหมด {$a})';
...
$string['eventgraderviewed'] = 'ดูตัวเลือกเปิดผู้ให้เกรดแล้ว';
$string['eventactivitygraded'] = 'กิจกรรมได้รับเกรดแล้วในเปิดผู้ให้เกรด';
$string['eventcommentdeleted'] = 'ลบความคิดเห็นแล้วในเปิดผู้ให้เกรด';
$string['eventcommentadded'] = 'เพิ่มความคิดเห็นแล้วในเปิดผู้ให้เกรด';
$string['privacy:metadata:preference:fullscreen'] = 'ระบุว่าผู้ใช้งานมีผู้ให้เกรดแบบเต็มจอหรือไม่';
$string['privacy:metadata:preference:showpostsgrouped'] = 'ระบุว่าผู้ใช้งานจะจัดกลุ่มกระดานเสวนาแบบเปิดเมื่อให้คะแนนหรือไม่';
$string['privacy:request:preference:fullscreenyes'] = 'ผู้ใช้งานต้องการใช้เปิดผู้ให้เกรดแบบเต็มหน้าจอ';
$string['privacy:request:preference:fullscreenno'] = 'ผู้ใช้งานต้องการใช้เปิดผู้ให้เกรดในมุมมองปกติ';
$string['privacy:request:preference:hsupostsgroupedyes'] = 'ผู้ใช้งานต้องการให้กระดานเสวนาแบบเปิดถูกจัดกลุ่มเมื่อให้คะแนน';
