...
$string['assign23-latesubmission'] = 'Uživatel {$a} odevzdal tento příspěvek pozdě.';
...
$string['activitycomment'] = 'Komentář';
...
$string['gradesavedx'] = 'Klasifikace ({$a}) byly úspěšně aktualizovány.';
...
$string['privacy:metadata:preference:showpostsgrouped'] = 'Informace, zda má uživatel při klasifikaci seskupená fóra Open Forum';
...
$string['privacy:request:preference:hsupostsgroupedyes'] = 'Uživatel preferuje seskupení fór Open Forum při jejich klasifikaci';
